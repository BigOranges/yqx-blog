  ...
  <nav class="navbar navbar-default" id="navbar">
    <div class="container">
      <div class="header-topbar hidden-xs link-border">
        ...
        @auth
          <li><a href="javascript:;" data-toggle="modal" data-target=".bs-example-modal-lg">发起提问</a></li>
        @endauth  
      ...
      {{ csrf_field() }}
        ...
        <div class="modal-body">
          <div class="form-group">
            ...
            <input type="email" class="form-control" id="loginModalUserNmae" name='email' placeholder="请输入邮箱名" autofocus autocomplete="off" required>
          </div>
          <div class="form-group">
